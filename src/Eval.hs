...
--       | objectType key == INT_OBJ = snd ((mapValue val)!!getIndexOfIntKey(intValue key, mapValue))
--       | objectType key == STRING_OBJ =snd ((mapValue val)!!getIndexOfStrKey(stringValue key, mapValue))
...
--       | objectType key == INT_OBJ = head [y | (x,y) <- mapValue o, intValue key == intValue x]
--       | objectType key == STRING_OBJ = head [y | (x,y) <- mapValue o, objectType x == STRING_OBJ && stringValue key == stringValue x] 
