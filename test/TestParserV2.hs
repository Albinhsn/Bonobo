...
testFN :: String 
testFN = statementsToString(parseStatements(getTokens(parseTokens(0, "fn add(){}; fn add(a){let five = 5;}; fn add(a,b){let c = a + b; return c;}; fn a(a,b){fn b(a,b){return 5;}; b(1,2);}; fn a(){if(True){let five = 5; return 5;}; return 2;};", []))))
...
testElse :: String 
testElse = statementsToString(parseStatements(getTokens(parseTokens(0, "if(True){}else{let five = 5;}; if(True){}else{if(True){}else{return 5};};", []))))
